...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _10741_archive_1.so
_10741_archive_1.so : archive.10/_10741_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic $(LD_NORELAX_FLAG)  -o .//../simv.daidir//_10741_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_10741_archive_1.so $@
