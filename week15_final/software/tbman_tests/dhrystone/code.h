...
#define Start_Timer() Begin_Time = *(volatile unsigned int *)(0x80001100);
#define Stop_Timer() End_Time = *(volatile unsigned int *)(0x80001100);
//#define Start_Timer() debug_printf("Timer is not implemented: Start Timer\n");
//#define Stop_Timer()  debug_printf("Timer is not implemented: End Timer\n");
