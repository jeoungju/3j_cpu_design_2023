  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  while (!Done) {
    ...
    setStats(1);
  debug_printf("Test Done -1\n");
  Start_Timer();
  //debug_printf("Test Done 0\n");
  ...
  //debug_printf("Test Done 1\n");
      Int_2_Loc = 3;
  //debug_printf("Test Done 2\n");
      strcpy (Str_2_Loc, "DHRYSTONE PROGRAM, 2'ND STRING");
  //debug_printf("Test Done 3\n");
      Enum_Loc = Ident_2;
  //debug_printf("Test Done 4\n");
      Bool_Glob = ! Func_2 (Str_1_Loc, Str_2_Loc);
  //debug_printf("Test Done 5\n");
	/* Bool_Glob == 1 */
      while (Int_1_Loc < Int_2_Loc)  /* loop body executed once */
      {
  //debug_printf("Test Done 6\n");
	Int_3_Loc = 5 * Int_1_Loc - Int_2_Loc;
	  /* Int_3_Loc == 7 */
  //debug_printf("Test Done 7\n");
	Proc_7 (Int_1_Loc, Int_2_Loc, &Int_3_Loc);
	  /* Int_3_Loc == 7 */
  //debug_printf("Test Done 8\n");
	Int_1_Loc += 1;
  //debug_printf("Test Done 9\n");
      } /* while */
    ...
    // Timer Use : You should comment below line
    //User_Time = 5000000;
    debug_printf("User_Time: %d\n", User_Time);
